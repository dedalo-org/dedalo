...
- [Your first round](getting-started/first-round.md)
...
- [Identities and wallets](concepts/identities.md)
- [Payout plans](concepts/plans.md)
...
- [In CI](operating/ci.md)
- [Funding from a multisig](operating/multisig.md)
- [Auditing a project](operating/auditing.md)

# Reference

- [Command line](reference/cli.md)
- [dedalo.toml](reference/configuration.md)
- [JSON output](reference/json.md)
- [GitHub Action](reference/action.md)
- [Exit codes and errors](reference/errors.md)
- [Using the library](reference/library.md)

# Trust

- [What is proved, and what is only tested](trust/verification.md)
- [The invariants](trust/invariants.md)
